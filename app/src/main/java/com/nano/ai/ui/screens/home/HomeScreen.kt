...
import com.nano.ai.activity.TempActivity
import com.nano.ai.model.ChatUiState
import com.nano.ai.ui.components.ModelLoadProgressBar
import com.nano.ai.ui.components.TTSPlaybackBarCompact
import com.nano.ai.ui.drawer.SettingsDrawerContent
import com.nano.ai.ui.theme.rDP
import com.nano.ai.viewModel.chatViewModel.ChatScreenViewModel
import com.nano.ai.viewModel.chatViewModel.ChattingViewModelFactory
...
private fun TopBarSection(
    ...
    onMenu: () -> Unit,
    onLeftMenu: () -> Unit,
    modelState: com.nano.ai.module.model.LoadState,
    ttsViewModel: TTSViewModel,
    uiState: ChatUiState,
    tokenRateState: TokenRateState,
    snackbarHostState: SnackbarHostState
