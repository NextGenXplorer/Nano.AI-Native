...
import com.nano.ai.model.Screen
import com.nano.ai.ui.screens.IntroScreen
...
import com.nano.ai.userdata.ntds.getOrCreateHardwareBackedAesKey
import com.nano.ai.userdata.ntds.loadEncryptedTree
import com.nano.ai.userdata.ntds.saveEncryptedTree
import com.nano.ai.util.makeToast
...
class MainActivity : ComponentActivity() {
    ...
    override fun onStart() {
        ...
        lifecycleScope.launch {
            com.nano.ai_engine.workers.model.ModelManager.init(applicationContext)
        }
    }
    ...
    override fun onDestroy() {
        ...
        com.nano.ai_engine.workers.model.ModelManager.shutdown(applicationContext)
